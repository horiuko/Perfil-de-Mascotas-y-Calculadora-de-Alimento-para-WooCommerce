...
if (categoria === 'Cachorro') {
	if (actividad === 'baja') {
		gramosRecomendados = peso * 0.06 * 100;
	} else if (actividad === 'media') {
		gramosRecomendados = peso * 0.08 * 100;
	} else {
		gramosRecomendados = peso * 0.10 * 100;
	}
} else if (categoria === 'Adulto') {
	if (actividad === 'baja') {
		gramosRecomendados = peso * 0.03 * 100;
	} else if (actividad === 'media') {
		gramosRecomendados = peso * 0.04 * 100;
	} else {
		gramosRecomendados = peso * 0.06 * 100;
	}
} else if (categoria === 'Senior') {
	if (actividad === 'baja') {
		gramosRecomendados = peso * 0.02 * 100;
	} else if (actividad === 'media') {
		gramosRecomendados = peso * 0.025 * 100;
	} else {
		gramosRecomendados = peso * 0.03 * 100;
	}
}
